...
rands = np.random.randint(1,101,(100,5))
print(rands)
#######
...
######
#df = pd.DataFrame(rands, columns=['f1','f2','f3','f4','label'])
...
#         for that call.)
finals = np.random.randint(0,100,(50,4))
df1 = pd.DataFrame(finals, columns=['A','B','C','D'])
print(df1)


##
random_numbers = np.random.randint(0,100,200).reshape(50,4)
col_names = ['A','B','C','D'] # 'A B C D'.split()
df2 = pd.DataFrame(data=random_numbers, columns=col_names)
print(df2)
